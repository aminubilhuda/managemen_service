...
## Corpus Check
- 347 files · ~237,855 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1977 nodes · 3002 edges · 278 communities (238 shown, 40 thin omitted)
...
### Community 2 - "InvoiceExport"
Cohesion: 0.08
Nodes (19): InvoiceExport, LabaRugiExport, TiketExport, PerusahaanController, Perusahaan, AppServiceProvider, Carbon\Carbon, Illuminate\Support\Collection (+11 more)
...
### Community 135 - "TiketServisController"
Cohesion: 0.12
Nodes (3): TiketServisController, StoreTiketRequest, UpdateStatusRequest
...
Cohesion: 0.16
Nodes (3): TiketServisController, DokumentasiUnit, TiketServis
...
### Community 142 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.15
Nodes (4): Illuminate\Database\Eloquent\Builder, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\HasMany, Illuminate\Database\Eloquent\Relations\HasOne
...
Cohesion: 0.15
Nodes (13): 6. Spesifikasi Rinci Setiap Layar & Alur Kerja (Screen-by-Screen), MODUL 2: BERANDA / DASHBOARD, MODUL 4: DOKUMENTASI FOTO UNIT, MODUL 5: KELOLA PELANGGAN, MODUL 6: PRODUK, SPAREPART & JASA, MODUL 8: PENGELUARAN TOKO (KAS KELUAR), S-04: Layar Beranda (Dashboard), S-10: Layar Kelola Foto Dokumentasi (+5 more)
...
### Community 148 - "Configuration Best Practices"
Cohesion: 0.33
...
### Community 194 - ".agents/skills/laravel-best-practices/SKILL.md"
Cohesion: 0.14
Nodes (11): Assert the Delivery Mode, Dispatch Queued Mail After Commit, Mail Best Practices, Queue Slow Mail Delivery, Separate Content and Delivery Tests, Use Markdown Mailables When They Fit, Consistency First, Decision Rules (+3 more)
...
### Community 204 - "Pengeluaran"
Cohesion: 0.17
Nodes (5): DashboardController, PengeluaranController, DetailInvoice, Pengeluaran, Carbon
...
### Community 224 - "MODUL 1: AUTENTIKASI & SETUP"
Cohesion: 0.50
Nodes (4): MODUL 1: AUTENTIKASI & SETUP, S-01: Layar Pengaturan Server IP / Base URL, S-02: Layar Login, S-03: Layar Profil & Ganti Kata Sandi
...
- **Why does `Controller` connect `Controller` to `User`, `LaporanController`, `InvoiceExport`, `Invoice`, `V1/TiketServisController.php`, `TiketServisController`, `Produk`, `Pelanggan`, `KategoriProduk`, `PengaturanPajak`, `Pengeluaran`, `TiketServis`, `ProfileController.php`, `Illuminate\Http\JsonResponse`, `Illuminate\Http\Request`?**
